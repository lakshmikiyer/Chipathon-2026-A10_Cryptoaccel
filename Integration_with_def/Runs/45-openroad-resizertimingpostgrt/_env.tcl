...
set ::env(TECH_LEF) /foss/pdks/gf180mcuD/libs.ref/gf180mcu_fd_sc_mcu7t5v0/techlef/gf180mcu_fd_sc_mcu7t5v0__max.tlef
set ::env(MACRO_LEFS) ""
set ::env(VDD_PIN) VDD
set ::env(GND_PIN) VSS
...
set ::env(DEFAULT_CORNER) max_ss_125C_3v00
set ::env(STA_CORNERS) "nom_tt_025C_3v30 max_ss_125C_3v00 min_ff_n40C_3v60"
...
set ::env(MAX_TRANSITION_CONSTRAINT) 6.0
set ::env(MAX_CAPACITANCE_CONSTRAINT) 0.1
...
set ::env(SYNTH_BUFFER_CELL) gf180mcu_fd_sc_mcu7t5v0__buf_4/I/Z
...
set ::env(GRT_RESIZER_HOLD_SLACK_MARGIN) 0.5
set ::env(GRT_RESIZER_SETUP_SLACK_MARGIN) 0.5
set ::env(GRT_RESIZER_HOLD_MAX_BUFFER_PCT) 75
...
set ::env(CURRENT_ODB) /foss/designs/ascon_run_deffile/runs/run11/44-openroad-repairantennas/1-openroad-diodeinsertion/A10_A.odb
set ::env(SAVE_ODB) /foss/designs/ascon_run_deffile/runs/run11/45-openroad-resizertimingpostgrt/A10_A.odb
set ::env(SAVE_DEF) /foss/designs/ascon_run_deffile/runs/run11/45-openroad-resizertimingpostgrt/A10_A.def
set ::env(SAVE_SDC) /foss/designs/ascon_run_deffile/runs/run11/45-openroad-resizertimingpostgrt/A10_A.sdc
set ::env(SAVE_NL) /foss/designs/ascon_run_deffile/runs/run11/45-openroad-resizertimingpostgrt/A10_A.nl.v
set ::env(SAVE_PNL) /foss/designs/ascon_run_deffile/runs/run11/45-openroad-resizertimingpostgrt/A10_A.pnl.v
