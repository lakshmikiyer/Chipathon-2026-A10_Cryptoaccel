...
set ::env(RCX_RULESET) /foss/pdks/gf180mcuD/libs.tech/librelane/rules.openrcx.gf180mcuD.max
set ::env(SAVE_SPEF) /foss/designs/ascon_run_deffile/runs/run11/57-openroad-rcx/max/A10_A.max.spef
