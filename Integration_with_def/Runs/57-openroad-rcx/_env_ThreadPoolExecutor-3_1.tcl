...
set ::env(CURRENT_DEF) /foss/designs/ascon_run_deffile/runs/run11/56-odb-cellfrequencytables/A10_A.def
set ::env(RCX_LEF) /foss/pdks/gf180mcuD/libs.ref/gf180mcu_fd_sc_mcu7t5v0/techlef/gf180mcu_fd_sc_mcu7t5v0__min.tlef
set ::env(RCX_RULESET) /foss/pdks/gf180mcuD/libs.tech/librelane/rules.openrcx.gf180mcuD.min
set ::env(SAVE_SPEF) /foss/designs/ascon_run_deffile/runs/run11/57-openroad-rcx/min/A10_A.min.spef
