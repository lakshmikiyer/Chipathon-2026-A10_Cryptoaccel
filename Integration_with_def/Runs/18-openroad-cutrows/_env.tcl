...
set ::env(CURRENT_ODB) /foss/designs/ascon_run_deffile/runs/run11/16-odb-setpowerconnections/A10_A.odb
set ::env(SAVE_ODB) /foss/designs/ascon_run_deffile/runs/run11/18-openroad-cutrows/A10_A.odb
set ::env(SAVE_DEF) /foss/designs/ascon_run_deffile/runs/run11/18-openroad-cutrows/A10_A.def
