...
set ::env(CURRENT_SPICE) /foss/designs/ascon_run_deffile/runs/run11/71-magic-spiceextraction/A10_A.spice
set ::env(CURRENT_PNL) /foss/designs/ascon_run_deffile/runs/run11/55-openroad-fillinsertion/A10_A.pnl.v
