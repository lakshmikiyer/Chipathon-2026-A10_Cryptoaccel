set ::env(TRACKS_INFO_FILE_PROCESSED) /foss/designs/ascon_run_deffile/runs/run11/13-openroad-floorplan/config.tracks
...
set ::env(FP_TRACKS_INFO) /foss/pdks/gf180mcuD/libs.tech/librelane/gf180mcu_fd_sc_mcu7t5v0/tracks.info
set ::env(FP_SIZING) absolute
set ::env(FP_ASPECT_RATIO) 1
set ::env(FP_CORE_UTIL) 50
set ::env(CORE_AREA) "20.0 20.0 1090.0 1090.0"
set ::env(BOTTOM_MARGIN_MULT) 2
set ::env(TOP_MARGIN_MULT) 2
set ::env(LEFT_MARGIN_MULT) 2
set ::env(RIGHT_MARGIN_MULT) 2
set ::env(CURRENT_NL) /foss/designs/ascon_run_deffile/runs/run11/06-yosys-synthesis/A10_A.nl.v
set ::env(SAVE_ODB) /foss/designs/ascon_run_deffile/runs/run11/13-openroad-floorplan/A10_A.odb
set ::env(SAVE_DEF) /foss/designs/ascon_run_deffile/runs/run11/13-openroad-floorplan/A10_A.def
set ::env(SAVE_SDC) /foss/designs/ascon_run_deffile/runs/run11/13-openroad-floorplan/A10_A.sdc
set ::env(SAVE_NL) /foss/designs/ascon_run_deffile/runs/run11/13-openroad-floorplan/A10_A.nl.v
set ::env(SAVE_PNL) /foss/designs/ascon_run_deffile/runs/run11/13-openroad-floorplan/A10_A.pnl.v
