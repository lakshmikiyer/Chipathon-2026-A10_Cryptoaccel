...
set ::env(SIGNOFF_SDC_FILE) /foss/designs/ascon_run_deffile/constraints_run2_maxtran6.sdc
set ::env(CURRENT_NL) /foss/designs/ascon_run_deffile/runs/run11/55-openroad-fillinsertion/A10_A.nl.v
set ::env(CURRENT_SPEF) "\"nom_*\" /foss/designs/ascon_run_deffile/runs/run11/57-openroad-rcx/nom/A10_A.nom.spef \"min_*\" /foss/designs/ascon_run_deffile/runs/run11/57-openroad-rcx/min/A10_A.min.spef \"max_*\" /foss/designs/ascon_run_deffile/runs/run11/57-openroad-rcx/max/A10_A.max.spef"
set ::env(CURRENT_ODB) /foss/designs/ascon_run_deffile/runs/run11/56-odb-cellfrequencytables/A10_A.odb
set ::env(SAVE_SDC) /foss/designs/ascon_run_deffile/runs/run11/58-openroad-stapostpnr/A10_A.sdc
