...
set ::env(CURRENT_ODB) /foss/designs/ascon_run_deffile/runs/run11/43-odb-heuristicdiodeinsertion/3-openroad-globalrouting/A10_A.odb
set ::env(SAVE_ODB) /foss/designs/ascon_run_deffile/runs/run11/44-openroad-repairantennas/1-openroad-diodeinsertion/A10_A.odb
set ::env(SAVE_DEF) /foss/designs/ascon_run_deffile/runs/run11/44-openroad-repairantennas/1-openroad-diodeinsertion/A10_A.def
