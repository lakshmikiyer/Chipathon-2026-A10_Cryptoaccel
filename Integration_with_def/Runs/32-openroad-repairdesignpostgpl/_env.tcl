...
set ::env(DESIGN_REPAIR_MAX_WIRE_LENGTH) 180
set ::env(DESIGN_REPAIR_MAX_SLEW_PCT) 35
set ::env(DESIGN_REPAIR_MAX_CAP_PCT) 35
set ::env(DESIGN_REPAIR_REMOVE_BUFFERS) 0
set ::env(CURRENT_ODB) /foss/designs/ascon_run_deffile/runs/run11/28-openroad-globalplacement/A10_A.odb
set ::env(SAVE_ODB) /foss/designs/ascon_run_deffile/runs/run11/32-openroad-repairdesignpostgpl/A10_A.odb
set ::env(SAVE_DEF) /foss/designs/ascon_run_deffile/runs/run11/32-openroad-repairdesignpostgpl/A10_A.def
set ::env(SAVE_SDC) /foss/designs/ascon_run_deffile/runs/run11/32-openroad-repairdesignpostgpl/A10_A.sdc
set ::env(SAVE_NL) /foss/designs/ascon_run_deffile/runs/run11/32-openroad-repairdesignpostgpl/A10_A.nl.v
set ::env(SAVE_PNL) /foss/designs/ascon_run_deffile/runs/run11/32-openroad-repairdesignpostgpl/A10_A.pnl.v
