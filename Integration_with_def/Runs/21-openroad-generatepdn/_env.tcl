...
set ::env(PDN_VSPACING) 1.6
set ::env(PDN_HSPACING) 1.6
set ::env(PDN_VPITCH) 100
set ::env(PDN_HPITCH) 100
...
set ::env(PDN_CORE_RING_VOFFSET) 1
set ::env(PDN_CORE_RING_HOFFSET) 1
...
set ::env(PDN_CFG) /foss/designs/ascon_run_deffile/pdn_cfg_a10.tcl
set ::env(CURRENT_ODB) /foss/designs/ascon_run_deffile/runs/run11/19-openroad-tapendcapinsertion/A10_A.odb
set ::env(SAVE_ODB) /foss/designs/ascon_run_deffile/runs/run11/21-openroad-generatepdn/A10_A.odb
set ::env(SAVE_DEF) /foss/designs/ascon_run_deffile/runs/run11/21-openroad-generatepdn/A10_A.def
set ::env(SAVE_SDC) /foss/designs/ascon_run_deffile/runs/run11/21-openroad-generatepdn/A10_A.sdc
set ::env(SAVE_NL) /foss/designs/ascon_run_deffile/runs/run11/21-openroad-generatepdn/A10_A.nl.v
set ::env(SAVE_PNL) /foss/designs/ascon_run_deffile/runs/run11/21-openroad-generatepdn/A10_A.pnl.v
