...
set ::env(CTS_SINK_CLUSTERING_ENABLE) 0
set ::env(CTS_CLK_MAX_WIRE_LENGTH) 0
set ::env(CTS_DISABLE_POST_PROCESSING) 0
set ::env(CTS_DISTANCE_BETWEEN_BUFFERS) 0
set ::env(CTS_ROOT_BUFFER) gf180mcu_fd_sc_mcu7t5v0__clkbuf_4
set ::env(CTS_CLK_BUFFERS) "gf180mcu_fd_sc_mcu7t5v0__clkbuf_2 gf180mcu_fd_sc_mcu7t5v0__clkbuf_4"
set ::env(CTS_APPLY_NDR) none
set ::env(CURRENT_ODB) /foss/designs/ascon_run_deffile/runs/run11/34-openroad-detailedplacement/A10_A.odb
set ::env(SAVE_ODB) /foss/designs/ascon_run_deffile/runs/run11/35-openroad-cts/A10_A.odb
set ::env(SAVE_DEF) /foss/designs/ascon_run_deffile/runs/run11/35-openroad-cts/A10_A.def
set ::env(SAVE_SDC) /foss/designs/ascon_run_deffile/runs/run11/35-openroad-cts/A10_A.sdc
set ::env(SAVE_NL) /foss/designs/ascon_run_deffile/runs/run11/35-openroad-cts/A10_A.nl.v
set ::env(SAVE_PNL) /foss/designs/ascon_run_deffile/runs/run11/35-openroad-cts/A10_A.pnl.v
